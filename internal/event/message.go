...
// repository) are omitted from metadata when empty. The payload slice is shared,
// not copied: messages are treated as immutable once created.
...
// SchemaVersion. Any violation is returned as an error wrapping
