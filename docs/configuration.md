...
server:
  ...
  listen: ":8080"
  # Path GitHub posts deliveries to. Must start with "/", must not end in "/"
  # or contain "{" or "}", and must be a clean path (no "//" or ".."
  # segments) - the receiver mounts it literally on a net/http ServeMux.
